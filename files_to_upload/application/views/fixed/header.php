...
<head>
      ...
      <link rel="stylesheet" type="text/css" href="<?= assets_url() ?>app-assets/vendors/css/tables/extensions/buttons.dataTables.min.css">
      
      <link rel="stylesheet" type="text/css" href="<?= assets_url() ?>app-assets/vendors/css/tables/datatable/select.dataTables.min.css">
       
      <link rel="stylesheet" type="text/css" href="<?= assets_url() ?>app-assets/vendors/css/tables/editor/editor.dataTables.min.css">
      <!-- END VENDOR CSS-->
      <!-- BEGIN STACK CSS-->
      ...
      <!-- END Custom CSS-->
      <script type="text/javascript" src="<?= assets_url() ?>app-assets/vendors/js/tables/jquery-1.12.3.js"></script>
      ...
      <script type="text/javascript" src="<?= assets_url() ?>app-assets/vendors/js/tables/datatable/jquery.dataTables.min.js"></script>
      <script type="text/javascript" src="<?= assets_url() ?>app-assets/vendors/js/tables/datatable/dataTables.buttons.min.js"></script>
      <script type="text/javascript" src="<?= assets_url() ?>app-assets/vendors/js/tables/datatable/dataTables.select.min.js"></script>
      
      <script type="text/javascript" src="<?= assets_url() ?>app-assets/vendors/js/tables/editor/dataTables.editor.min.js"></script>
