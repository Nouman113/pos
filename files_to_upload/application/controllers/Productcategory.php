...
class Productcategory extends CI_Controller
{
    ...
    function getCategories(){
        ...
        $data = $this->products_cat->category_stock();
        // var_dump($data);
    ...
    public function getSubCategories($id=0)
    {
        $dd=$_GET['id'];
        // var_dump($_GET);
        $data=json_encode($this->products_cat->category_sub_stock($dd));
        // var_dump($data);
        // $data['category_list']=$this->products_cat->category_list_for_sub();
